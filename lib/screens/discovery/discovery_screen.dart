  ...
  _PlaceSection(
    ...
    places: <_Place>[
      _Place(
        ...
        category: 'Seafood',
        description:
            'A beloved local seafood spot serving fresh catches from the East Sea. Known for grilled fish, shrimp, and crab at great prices.',
      ...
      _Place(
        ...
        category: 'Vietnamese',
        description:
            'Authentic Mi Quang — a Central Vietnamese noodle dish with turmeric-tinted noodles, pork, shrimp, and fresh herbs.',
      ...
      _Place(
        ...
        description:
            'Famous banh mi shop known worldwide for its crispy baguette loaded with pâté, cold cuts, and pickled vegetables.',
      ...
      _Place(
        ...
        category: 'Vietnamese',
        description:
            'Upscale Vietnamese dining in a beautifully restored colonial building. Great for groups and special occasions.',
  ...
  _PlaceSection(
    ...
    places: <_Place>[
      _Place(
        ...
        description:
            'A large amusement park featuring the iconic Sun Wheel — one of the largest Ferris wheels in Asia — plus rides and cultural pavilions.',
      ...
      _Place(
        ...
        description:
            'Learn to surf on My Khe Beach with certified instructors. Board rental, lessons for all levels, and a chill beach vibe.',
      ...
      _Place(
        ...
        category: 'Attraction',
        description:
            'Five marble and limestone hills with caves, tunnels, and Buddhist sanctuaries. Climb to the summit for panoramic views over Da Nang.',
      ...
      _Place(
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1540202403-b7abd6747a18?w=600',
        rating: 4.8,
        reviewCount: 1560,
        price: 'Free',
        hours: 'Open 24h',
        ...
        category: 'Nature',
        description:
            'A forested peninsula jutting into the sea, home to the golden Linh Ung Pagoda and rare red-shanked douc langurs.',
  ...
  _PlaceSection(
    ...
    places: <_Place>[
      _Place(
        ...
        description:
            'Da Nang\'s highest rooftop bar on the 36th floor of the Novotel. Stunning views of the Han River, great cocktails and DJ sets on weekends.',
      ...
      _Place(
        ...
        category: 'Bar',
        description:
            'Relaxed rooftop bar with river views, craft beers, and a buzzing happy hour from 4–6PM daily.',
      ...
      _Place(
        ...
        category: 'Café',
        description:
            'A cozy multi-level café popular with students and remote workers. Great Vietnamese iced coffee, smoothies, and light bites.',
      ...
      _Place(
        ...
        category: 'Bar',
        description:
            'Riverside bar with a breezy terrace, live music on Friday nights, and a solid selection of imported craft beers.',
  ...
  _PlaceSection(
    ...
    places: <_Place>[
      _Place(
        ...
        category: 'Hotel',
        description:
            'Modern 4-star hotel in the city centre with rooftop pool, spa, and stunning views of the Han River and Dragon Bridge.',
      ...
      _Place(
        ...
        category: 'Resort',
        description:
            'Beachfront 5-star resort directly on My Khe Beach. Features multiple pools, a private beach, and world-class dining.',
      ...
      _Place(
        ...
        category: 'Hotel',
        description:
            'Well-located 4-star hotel one block from My Khe Beach. Outdoor pool, breakfast included, and great value for money.',
      ...
      _Place(
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1551882547-ff40c4a49ce5?w=600',
        rating: 4.3,
        reviewCount: 870,
        price: r'$$',
        hours: 'Check-in 3PM',
        ...
        category: 'Hotel',
        description:
            'City-centre hotel with Han River views, rooftop bar, and convenient access to restaurants and nightlife.',
...
List<_Place> get _kAllPlaces =>
    _kSections
        .where(
          (_PlaceSection s) => s.cardType != _SectionCardType.collectionList,
        )
      ...
      slivers.add(
        SliverToBoxAdapter(
          child: _SectionHeader(
            ...
            onSeeMore:
                section.cardType == _SectionCardType.placeList
                    ? () => _onSeeMore(section)
                    : null,
          ),
        ),
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount:
                  section.cardType == _SectionCardType.collectionList
    ...
    return <Widget>[
      ...
      SliverToBoxAdapter(
        child: _buildDetailSectionHeader(
          context,
          'Google reviews · ${_fmtCount(place.reviewCount)}',
        ),
      ),
...
class _CollectionHorizontalCard extends StatelessWidget {
  const _CollectionHorizontalCard({
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: Responsive.w(context, 3)),
                      Text(
                        '${place.rating} (${_fmt(place.reviewCount)})',
                        style: textTheme.bodySmall?.copyWith(
                          fontWeight: FontWeight.w600,
                        ),
                      ),
